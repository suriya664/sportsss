  ...
  return (
    <div className="h-screen bg-gray-50 flex overflow-hidden">
      ...
      <motion.aside
        ...
        className={`fixed inset-y-0 left-0 z-40 bg-gradient-to-b from-blue-700 to-blue-900 text-white shadow-2xl flex flex-col h-full ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-blue-500 bg-gradient-to-r from-blue-700 to-blue-600">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`${isDesktop ? 'hidden' : 'block'} text-white hover:text-blue-200 transition-colors`}
              >
          ...
          {/* Persistent Operations CTA */}
          <div className="p-4 mt-auto">
            <div className="bg-gradient-to-br from-blue-500/30 to-indigo-500/30 backdrop-blur-md rounded-2xl p-4 border border-white/10 shadow-inner">
              <div className="flex items-center space-x-3 mb-3">
                <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                  <span className="text-lg">📈</span>
                </div>
                <h4 className="font-nunito font-bold text-sm text-white">Operations</h4>
              </div>
              <p className="text-xs text-blue-100 mb-3 font-lato leading-relaxed">
                Check daily inventory targets. Need help with stock management?
              </p>
              <button className="w-full py-2 bg-white text-blue-700 rounded-lg text-xs font-bold hover:bg-blue-50 transition-colors shadow-md">
                Operations Guide
              </button>
            </div>
          </div>

          {/* Enhanced Staff User Info */}
          <div className="p-4 border-t border-white/10 bg-black/10">
            <div className="flex items-center space-x-3 mb-4">
              <div className="relative">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-indigo-600 flex items-center justify-center shadow-lg ring-2 ring-white/20">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-lato font-bold text-xs truncate text-white">{user?.name || 'Staff'}</p>
                <p className="font-lato text-[10px] text-blue-200 truncate">{user?.email || 'staff@sportsequip.com'}</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-16">
            <div className="flex items-center space-x-4">
              <button
                ...
                className={`${isDesktop ? 'hidden' : 'block'} p-2 text-blue-600 hover:bg-mountain-gray rounded-lg transition-colors`}
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {inventoryAlerts.length > 0 ? (
                    <div className="space-y-4">
                      {inventoryAlerts.map((alert) => (
                        <div
                          key={alert.id}
                          className={`p-5 rounded-xl border-l-4 shadow-md ${alert.severity === 'critical'
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${alert.severity === 'critical' ? 'bg-red-500' : 'bg-yellow-500'
                                }`}>
                                ⚠️
                              </div>
                              <div>
                        ...
                        <div className="flex items-center space-x-4 flex-1">
                          ...
                          <div>
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <span className={`px-3 py-1 rounded-full text-xs font-lato font-semibold ${shipment.status === 'Delivered'
                            ...
                            <div className="mt-2 w-full bg-mountain-gray rounded-full h-2">
                              <div
                                className={`h-2 rounded-full ${shipment.progress === 100 ? 'bg-green-500' :
                ...
                <div className="space-y-4">
                  {notifications.map((notif) => (
                    <div key={notif.id} className="flex items-start gap-4 p-5 border-l-4 border-purple-500 bg-gradient-to-r from-purple-50 to-transparent rounded-lg hover:shadow-md transition-all">
                      ...
                      <span className={`px-3 py-1 rounded-full text-xs font-lato capitalize ${notif.type === 'order' ? 'bg-yellow-100 text-yellow-800' :
